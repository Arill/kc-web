<template>
  <div class="mx-1 pb-2">
    <div class="d-flex ml-2 fleet-header flex-wrap">
      <div class="mt-1 caption text--secondary">Air Power:</div>
      <div class="mt-1 ml-1 mr-3 body-2">{{ fleet.fullAirPower }}</div>
      <div class="mt-1 caption text--secondary">Contact:</div>
      <div class="mt-1 ml-1 mr-3 body-2">{{ contactRate }}%</div>
      <div class="mt-1 caption text--secondary">N.Contact:</div>
      ...
      <div class="d-flex ml-6">
        <div class="mt-1 align-self-center caption d-capture-none">Details:</div>
